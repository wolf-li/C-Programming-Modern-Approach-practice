...
int main(void){
    char command;
    printf("Guess the scret number between 1 and %d\n\n", MAX_NUMBER);
...
void initialize_number_generator(void){
    // 使用 time 作为 seed ，srand 产生随机数
    srand((unsigned) time(NULL));
}

/*********************************************************
 * chose_new_secret_number: Randomly selects a number    *
 ...
 *               the useer whether each guess is too low *
